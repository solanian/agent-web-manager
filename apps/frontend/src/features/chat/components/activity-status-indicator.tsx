...
function extractToolName(
	toolCall: NonNullable<LiveMessage["toolCall"]>,
): string {
	...
	function ActivityStatusIndicatorComponent({
		...
		return (
			...
			>
				...
				{showSpinner && <Loader size={12} className="text-muted-foreground" />}
...
export const ToolbarActivityIndicator = memo(
	function ToolbarActivityIndicatorComponent({
		activity,
		className,
	}: {
		activity: ActivityDetail;
