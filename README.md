...
<p align="center"><strong>Agent Web Manager</strong></p>
<p align="center">A Kimi-style multi-backend console for Codex, Claude Code, and Kimi CLI.</p>
<p align="center">Run multiple local agent backends. Control them from one web UI. Keep the UX familiar, but the orchestration independent.</p>
